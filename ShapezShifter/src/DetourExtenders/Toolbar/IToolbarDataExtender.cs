namespace ShapezShifter
{
    ...
    /// </summary>
    /// <remarks>
    /// Implementing this extender is more indicated when you trying to change the toolbar slot data or adding a new
    /// building. When creating toolbar elements with extra functionality that does not exist in the base game consider
    /// using <see cref="IToolbarDataExtender"/>. If you are writing a custom scenario, the toolbar data can be specified on
    /// it 
    /// </remarks>
    public interface IToolbarDataExtender : IExtender
    {
