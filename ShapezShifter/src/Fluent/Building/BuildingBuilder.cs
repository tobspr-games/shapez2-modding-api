...
namespace ShapezShifter.Fluent
{
        ...
        IIdentifiableConnectableRenderablePredictableAudibleConfigurableBuildingBuilder
    {
        ...
        {
            var efficiencyData = new BuildingEfficiencyData(2.0f, 1);
        ...
        private void CopyBuildingRenderingFromExisting(GameBuildings gameBuildings)
        {
            ...
            var definitionToCopyFrom = gameBuildings.GetDefinition(DefinitionToCopyFrom.value);
        ...
        {
            var placementPreferenceData = new EntityPlacementPreferenceData(group.AutoConnect,
                group.AutoAttractIOScoreMultiplier);

            var replacementPreferenceData =
